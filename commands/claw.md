...
Start an interactive AI agent session that persists conversation history to disk and optionally loads EOC skill context.
...
3. Optionally loads EOC skill context from `CLAW_SKILLS` env var
