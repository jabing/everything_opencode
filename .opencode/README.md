...
There are two ways to use Everything OpenCode:

1. **npm package (recommended for most users)**  
   Install via npm/bun/yarn and use the `everything-opencode` CLI to set up rules and agents.
...
```bash
npx everything-opencode typescript
```
