...
# 暗黑科技风格
BACKGROUND_COLOR = RGBColor(10, 10, 10)
CARD_COLOR = RGBColor(30, 30, 35)
PRIMARY_COLOR = RGBColor(0, 212, 255)
ACCENT_COLOR = RGBColor(0, 255, 255)
HIGHLIGHT_COLOR = RGBColor(255, 0, 255)
TEXT_COLOR = RGBColor(255, 255, 255)
CODE_COLOR = RGBColor(0, 255, 136)
...
def add_resources_slide(prs, title, resources):
    slide_layout = prs.slide_layouts[6]
    slide = prs.slides.add_slide(slide_layout)
    ...
    for name, url in resources:
        ...
        name_text = card.text_frame
        name_text.text = name
        name_para = name_text.paragraphs[0]
        name_para.font.size = Pt(20)
        name_para.font.bold = True
        name_para.font.color.rgb = PRIMARY_COLOR
        name_para.font.name = BODY_FONT
        
        url_para = name_text.add_paragraph()
        url_para.text = url
        url_para.font.size = Pt(14)
        url_para.font.color.rgb = CODE_COLOR
        url_para.font.italic = True
        url_para.font.name = CODE_FONT
...
if __name__ == "__main__":
    ...
    output_path = "opencode-training-presentation/OpenCode安装与配置指南-最终版.pptx"
    ...
    print(f"   - OpenCode: https://github.com/opencode-ai/opencode")
    print(f"   - Easy-OpenCode: https://github.com/jabing/easy_opencode")
    print(f"   - DeepSeek: https://platform.deepseek.com/")
    print(f"✨ 特性: 暗黑主题、霓虹强调、代码高亮、完整命令、资源链接")
